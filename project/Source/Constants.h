...
constexpr float LIGHT_DIFFUSE_STRENGTH = 0.0f;			// Intensity of the diffuse light
constexpr float LIGHT_SPECULAR_STRENGTH = 0.0f;			// Intensity of the specular light
