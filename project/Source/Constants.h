...
constexpr char* TEXTURE_PATH_L = "../Assets/Textures/LetterL.jpg";
constexpr char* TEXTURE_PATH_V = "../Assets/Textures/LetterV.jpg";
constexpr char* TEXTURE_PATH_S = "../Assets/Textures/LetterS.jpg";
constexpr char* TEXTURE_PATH_COLON = "../Assets/Textures/Colon.jpg";
constexpr char* TEXTURE_PATH_HEART = "../Assets/Textures/heart.jpg";
constexpr char* TEXTURE_PATH_1 = "../Assets/Textures/number1.jpg";
constexpr char* TEXTURE_PATH_2 = "../Assets/Textures/number2.jpg";
constexpr char* TEXTURE_PATH_3 = "../Assets/Textures/number3.jpg";
constexpr char* TEXTURE_PATH_4 = "../Assets/Textures/number4.jpg";
constexpr char* TEXTURE_PATH_5 = "../Assets/Textures/number5.jpg";
constexpr char* TEXTURE_PATH_6 = "../Assets/Textures/number6.jpg";
constexpr char* TEXTURE_PATH_7 = "../Assets/Textures/number7.jpg";
constexpr char* TEXTURE_PATH_8 = "../Assets/Textures/number8.jpg";
constexpr char* TEXTURE_PATH_9 = "../Assets/Textures/number9.jpg";
constexpr char* TEXTURE_PATH_0 = "../Assets/Textures/number0.jpg";
