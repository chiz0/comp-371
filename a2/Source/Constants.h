...
constexpr float LIGHT_SPECULAR_STRENGTH = 0.8f;			// Intensity of the specular light
constexpr vec3 LIGHT_OFFSET = vec3(5.0f, 10.0f, 5.0f);	// Where, relative to the focused object, to place the light source
