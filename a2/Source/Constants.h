...
constexpr float LIGHT_AMBIENT_STRENGTH = 0.71f;			// Intensity of the ambient light
constexpr float LIGHT_DIFFUSE_STRENGTH = 0.74f;			// Intensity of the diffuse light
constexpr float LIGHT_SPECULAR_STRENGTH = 0.75f;			// Intensity of the specular light
